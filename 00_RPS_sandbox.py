...
class Converter:
    def __init__(self):
        ...
        self.temp_heading_label = Label(self.converter_frame, text="Coconut Mall",
                                        font="Arial 19 bold",
                                        bg=background_color,
                                        padx=10, pady=10)
        ...
        self.temp_instructions_label = Label(self.converter_frame,
                                            text="YOU JUST GOT COCONUT MALL'D",
        ...
        self.to_c_button = Button(self.conversion_buttons_frame, text="To yes", font="Arial 10 bold",
                                  bg="Khaki1", padx=10, pady=10, command=lambda: self.temp_convert(-459))
        self.to_c_button.grid(row=0, column=0)

        self.to_f_button = Button(self.conversion_buttons_frame, text="To nop", font="Arial 10 bold",
                                  bg="Orchid1", padx=10, pady=10, command=lambda: self.temp_convert(-273))
        self.to_f_button.grid(row=0, column=1)

        # Answer label (row 4)

        self.converted_label = Label(self.converter_frame, font="Arial 16 bold", fg="blue", bg=background_color,
                                     pady=10, padx=10)
    ...
    def temp_convert(self, low):
        ...
        try:
            ...
            if low == -273 and to_convert >= low:
                ...
                answer = "{} degrees no is {} degrees nobutmabeyes".format(to_convert, fahrenheit)
            ...
            # Convert to C
                ...
                answer = "{} degrees no is {} degrees yes".format(to_convert, celsius)
